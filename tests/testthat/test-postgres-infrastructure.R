...
# =============================================================================
# POSTGRESQL TEST INFRASTRUCTURE TESTS
# =============================================================================
# These tests verify that the Docker container setup and helper functions
# work correctly. They are separated from the dialect tests because they
# are slower and test the test infrastructure rather than the ORM itself.
