...
Classes <- engine$model(
    ...
    subject = Column('TEXT'),
    teacher_id = ForeignKey('INTEGER', ref_table = 'teachers', ref_column = 'id'),
...
`ForeignKey` is a special case of Column that specifies a foreign key relationship to another table. You define the reference by providing the target table and column explicitly via `ref_table` and `ref_column`.
