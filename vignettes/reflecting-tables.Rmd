---
title: "Reflecting Models from Existing Tables"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Reflecting Models from Existing Tables}
...
Every reflected `ForeignKey` whose target was also reflected is turned into a
...
Foreign keys pointing at tables outside the reflected set are skipped with a
...
target lives in a different schema, so `reflect_schema()` handles cross-schema
